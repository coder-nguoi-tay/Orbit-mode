...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::accounts::check_provider_account,
            commands::accounts::authenticate_provider_account,
            commands::accounts::rename_provider_account,
            commands::accounts::set_default_provider_account,
            commands::accounts::set_project_provider_account,
            commands::accounts::get_project_codex_account,
            commands::accounts::clear_project_codex_account,
            commands::accounts::set_provider_account_auto_handoff,
            commands::accounts::get_provider_account_auto_handoff,
